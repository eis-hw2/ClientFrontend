        ...
        u = i.a.createElement(
          ...
          i.a.createElement(
            ...
            i.a.createElement(
              ...
              i.a.createElement(l['FormattedMessage'], { id: 'app.register-result.view-mailbox' })
            )
          ),
          i.a.createElement(
            c.a,
            ...
            i.a.createElement(
              s['a'],
              { size: 'large' },
              i.a.createElement(l['FormattedMessage'], { id: 'app.register-result.back-home' })
            )
          )
        ),
        g = function(e) {
          ...
          return i.a.createElement(o['a'], {
            className: p.a.registerResult,
            type: 'success',
            title: i.a.createElement(
              'div',
              { className: p.a.title },
              i.a.createElement(l['FormattedMessage'], {
                id: 'app.register-result.msg',
                values: { email: t.state ? t.state.account : 'AntDesign@example.com' },
              })
            ),
            description: Object(l['formatMessage'])({ id: 'app.register-result.activation-email' }),
            actions: u,
            style: { marginTop: 56 },
          });
        };
